...
const ArtworkCard = ({ artwork, onLikeChange, onFavoriteChange, onDelete }) => {
  const { user } = useAuth();
              ...
              {artwork.isOwn ? (
                ...
                <>
                  <Link
                    ...
                    className="p-2 bg-blue-600/80 backdrop-blur-sm rounded-full text-white hover:bg-blue-500 transition-colors duration-300"
                    title="Edit artwork"
                  >
                  ...
                  <button
                    ...
                    className="p-2 bg-red-600/80 backdrop-blur-sm rounded-full text-white hover:bg-red-500 transition-colors duration-300"
